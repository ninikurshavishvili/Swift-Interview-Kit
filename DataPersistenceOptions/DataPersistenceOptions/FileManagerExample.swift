...
/** ⚠️ ფაილურ სისტემაში მგრძნობიარე ინფორმაციის შენახვამ შეიძლება რისკები შექმნას. ფაილური ოპერაციები შეიძლება იყოს უფრო ნელი, ვიდრე მეხსიერებაში მონაცემთა შენახვის მექანიზმები
 არ აქვს ჩაშენებული დაშიფვრა: FileManager არ უზრუნველყოფს დაშიფვრას შენახული ფაილებისთვის, რაც შესაძლოა საჭირო იყოს მგრძნობიარე მონაცემებისთვის
 */
