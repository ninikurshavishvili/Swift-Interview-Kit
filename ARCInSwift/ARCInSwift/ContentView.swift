...
/*
 ...
 3. unowned - reference იკავებს შუალედურ პოზიციას, არც ძლიერი ბმა აქვს და არც optional-ია, ანუ კომპაილერი ჩათვლის რომ ობიექტი არ არის dealocated, რადგან თავად რეფერენსი გამოყოფილია.
 */
