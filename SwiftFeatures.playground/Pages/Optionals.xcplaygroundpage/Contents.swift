...
/*
 Implicitly Unwrapped Optionl-ები ძალიან გავს ჩვეულებრივ ოფშენალებს მაგრამ, ის ავტომატურად აკეთებს unwrapp-ს, როგორც კი მას წვდები. მხოლოდ მაშინ უნდა გამოიყენოთ, როდესაც დარწმუნებული ხართ, რომ მნიშვნელობა არ იქნება nil საწყისი მინიჭების შემდეგ.
 */

var age: Int! = nil
age += 1 // ეს დაარტყავს რანთაიმ ერორს
